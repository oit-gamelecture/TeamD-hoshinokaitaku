...
public class Astronaut4 : MonoBehaviour
{
    public Vector3[] jumpTargets = new Vector3[] {
        new Vector3(-44f, 3.75f, 14.12f),
        new Vector3(-29f, 3.75f, 50.37f),
        new Vector3(3.1f, 3.75f, 73.57f),
        new Vector3(39.52f, 3.75f, 46.68f),
        new Vector3(65.1f, 3.75f, 15.67f),
        new Vector3(71.8f, 3.75f, -25.38f),
        new Vector3(61.75f, 3.75f, -65.1f),
        new Vector3(40.49f, 3.75f, -91.67f),
        new Vector3(6.68f, 3.75f, -109.64f),
        new Vector3(-29.89f, 3.75f, -84.34f),
        new Vector3(-47.4f, 3.75f, -51.65f),
        new Vector3(-51.31f, 3.75f, -20.5f)
    }; // 跳躍する目標位置
