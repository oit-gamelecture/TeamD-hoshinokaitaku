...
public class Astronaut2 : MonoBehaviour
{
    public Vector3[] jumpTargets = new Vector3[] {
        new Vector3(-44f, 3.75f, 24.12f),
        new Vector3(-29f, 3.75f, 60.37f),
        new Vector3(3.1f, 3.75f, 83.57f),
        new Vector3(39.52f, 3.75f, 56.68f),
        new Vector3(65.1f, 3.75f, 25.67f),
        new Vector3(71.8f, 3.75f, -15.38f),
        new Vector3(61.75f, 3.75f, -55.1f),
        new Vector3(40.49f, 3.75f, -81.67f),
        new Vector3(6.68f, 3.75f, -99.64f),
        new Vector3(-29.89f, 3.75f, -74.34f),
        new Vector3(-47.4f, 3.75f, -41.65f),
        new Vector3(-51.31f, 3.75f, -10.5f)
    }; // 跳躍する目標位置
